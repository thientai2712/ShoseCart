...
let products = [
    ...
    new product(2, "SUPERSTAR", "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/7ed0855435194229a525aad6009a0497_9366/Giay_Superstar_trang_EG4958_01_standard.jpg", 1750000, 1, 40),
    new product(3, "RETROPY E5", "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/b6d962830baf42139221ad4e014f032e_9366/Giay_Retropy_E5_Mau_xanh_da_troi_GW6059_01_standard.jpg", 1250000, 1, 40),
    new product(4, "ULTRABOOST 21", "https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/4f14062ee23c411eba1bad5c0080abbb_9366/Giay_UltraBoost_21_COLD.RDY_DJen_FZ2558_01_standard.jpg", 1650000, 1, 40),
...
function renderProduct() {
    let htmls = products.map(function (product) {
        ...
        `
        {/* <span><input type="number" value="${product.size}"min="40" max="44"></span> */ }
...
function showCartDetail() {
    let htmls = cart.map(function (item, index) {
        ...
        <tr class = "tr_${cart.id}">
                    ...
                    <td class="td_price">${formatCurrency(item.price)}</td>
